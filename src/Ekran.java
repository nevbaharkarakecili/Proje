...
ArrayList<Ekipman> ekipmanlar = new ArrayList<>();
    ...
    public void ExcelYazdr() throws IOException, WriteException {
        ...
        Label label = new Label(0, 0, "Müşteri");
        sheet.addCell(label);
        label = new Label(0, 1, jComboBoxMusteri.getSelectedItem().toString());
        sheet.addCell(label);
        label = new Label(1, 0, "Muayene Prosedürü");
        sheet.addCell(label);
        label = new Label(1, 1, jTextFieldMuayeneProsedur.getText());
        sheet.addCell(label);
        label = new Label(2, 0, "Sayfa No");
        sheet.addCell(label);
